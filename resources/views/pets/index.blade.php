...
<!-- Stats Section -->
<div id="stats" class="bg-gradient-to-r from-white via-primary-50 to-white py-20">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-16">
            <h2 class="text-4xl md:text-5xl font-bold text-gray-800 mb-6">Nosso Impacto</h2>
            <p class="text-xl text-gray-600 max-w-3xl mx-auto">Juntos, estamos transformando vidas e criando histórias de amor</p>
        </div>
        
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div class="card p-8 text-center hover-lift">
                <div class="w-20 h-20 bg-gradient-to-r from-primary-500 to-primary-600 rounded-3xl flex items-center justify-center mx-auto mb-6 shadow-lg">
                    <i class="fas fa-heart text-white text-3xl"></i>
                </div>
                <h3 class="text-4xl font-bold text-gray-800 mb-3 counter" data-target="{{ $pets->total() }}">0</h3>
                <p class="text-gray-600 text-lg font-medium">Pets disponíveis para adoção</p>
                <div class="w-16 h-1 bg-gradient-to-r from-primary-500 to-primary-600 rounded-full mx-auto mt-4"></div>
            </div>
            
            <div class="card p-8 text-center hover-lift">
                <div class="w-20 h-20 bg-gradient-to-r from-accent-500 to-accent-600 rounded-3xl flex items-center justify-center mx-auto mb-6 shadow-lg">
                    <i class="fas fa-home text-white text-3xl"></i>
                </div>
                <h3 class="text-4xl font-bold text-gray-800 mb-3 counter" data-target="1247">0</h3>
                <p class="text-gray-600 text-lg font-medium">Adoções realizadas</p>
                <div class="w-16 h-1 bg-gradient-to-r from-accent-500 to-accent-600 rounded-full mx-auto mt-4"></div>
            </div>
            
            <div class="card p-8 text-center hover-lift">
                <div class="w-20 h-20 bg-gradient-to-r from-secondary-500 to-secondary-600 rounded-3xl flex items-center justify-center mx-auto mb-6 shadow-lg">
                    <i class="fas fa-users text-white text-3xl"></i>
                </div>
                <h3 class="text-4xl font-bold text-gray-800 mb-3 counter" data-target="892">0</h3>
                <p class="text-gray-600 text-lg font-medium">Famílias felizes</p>
                <div class="w-16 h-1 bg-gradient-to-r from-secondary-500 to-secondary-600 rounded-full mx-auto mt-4"></div>
            </div>
        </div>
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-6 mt-16">
            <div class="text-center">
                <div class="text-2xl font-bold text-primary-600 mb-2 counter" data-target="24">0</div>
                <div class="text-gray-600">Estados atendidos</div>
            </div>
            <div class="text-center">
                <div class="text-2xl font-bold text-accent-600 mb-2 counter" data-target="156">0</div>
                <div class="text-gray-600">Cidades ativas</div>
            </div>
            <div class="text-center">
                <div class="text-2xl font-bold text-secondary-600 mb-2 counter" data-target="98">0</div>
                <div class="text-gray-600">% Taxa de sucesso</div>
            </div>
            <div class="text-center">
                <div class="text-2xl font-bold text-primary-600 mb-2 counter" data-target="4.9">0</div>
